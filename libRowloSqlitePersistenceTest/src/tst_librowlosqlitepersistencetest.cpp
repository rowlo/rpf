 ...
 *
 * File:    libRowloSqlitePersistenceTest/include/tst_librowlosqlitepersistencetest.cpp
...
int main(int argc, char** argv)
{
    ...
    rowlo::persistence::sqlite::test::SQLiteDataBaseFacadeTest sqliteDataBaseFacadeTest;
    result += QTest::qExec(&sqliteDataBaseFacadeTest, argc, argv);
